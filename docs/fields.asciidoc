...
--
This document describes the fields that are exported by moviebeat. They are
...
{'fields': [{'required': True, 'type': 'keyword', 'name': 'imdb.id', 'description': 'PLEASE UPDATE DOCUMENTATION\n'}, {'required': True, 'type': 'keyword', 'name': 'imdb.type', 'description': 'PLEASE UPDATE DOCUMENTATION\n'}, {'required': True, 'type': 'text', 'name': 'title.primary', 'description': 'PLEASE UPDATE DOCUMENTATION\n'}, {'required': False, 'type': 'text', 'name': 'title.original', 'description': 'PLEASE UPDATE DOCUMENTATION\n'}, {'required': True, 'type': 'boolean', 'name': 'is_adult', 'description': 'PLEASE UPDATE DOCUMENTATION\n'}, {'required': False, 'type': 'integer', 'name': 'start_year', 'description': 'PLEASE UPDATE DOCUMENTATION\n'}, {'required': False, 'type': 'text', 'name': 'end_year', 'description': 'PLEASE UPDATE DOCUMENTATION\n'}, {'format': 'duration', 'required': False, 'type': 'integer', 'description': 'PLEASE UPDATE DOCUMENTATION\n', 'name': 'duration'}, {'required': False, 'type': 'keyword', 'name': 'imdb.genres', 'description': 'PLEASE UPDATE DOCUMENTATION\n'}]}
